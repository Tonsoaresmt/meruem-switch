...
#---------------------------------------------------------------------------------
# TARGET   = nome do .nro de saida (NAO usar o nome da pasta: ela pode ter espaco)
# BUILD    = onde ficam os objetos intermediarios
# SOURCES  = pastas com codigo-fonte
# INCLUDES = pastas com cabecalhos (stb_image.h, miniz.h, etc.)
# ROMFS    = pasta com assets embutidos no .nro (fontes, icones) — opcional
#---------------------------------------------------------------------------------
TARGET		:=	Meruem
BUILD		:=	build
SOURCES		:=	source
...
#---------------------------------------------------------------------------------
# Ferramenta de configuracao de flags das portlibs do Switch
#---------------------------------------------------------------------------------
